...
import { Menu, X, Phone, Mail, MapPin, ChevronDown, User, LogOut, Settings } from 'lucide-react';
              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive(item.href) ? 'bg-primary/10 text-primary font-semibold' : 'text-foreground/80 hover:bg-secondary'
                  )}
